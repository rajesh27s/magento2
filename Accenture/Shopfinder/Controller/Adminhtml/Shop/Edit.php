...
////use Accenture\Shopfinder\Controller\RegistryConstants;
...
class Edit extends \Magento\Backend\App\Action {
    ...
    protected function _initAction() {
        ...
        $resultPage->setActiveMenu('Accenture_Shopfinde::shop')
                ->addBreadcrumb(__('Shop'), __('Shop'))
                ->addBreadcrumb(__('Manage Shop'), __('Manage Shop'));
        return $resultPage;
    }
    ...
    public function execute() {
        ...
        $this->_coreRegistry->register('shop_data', $model);
        // 5. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->_initAction();
        $resultPage->addBreadcrumb(
                $id ? __('Edit Shop') : __('New Shop'), $id ? __('Edit Shop') : __('New Shop')
        );
